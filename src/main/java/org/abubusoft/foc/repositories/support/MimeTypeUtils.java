...
/**
 * Preso da https://gist.github.com/harshjv/d90de06630da34e2f6b4
 *
 */
public class MimeTypeUtils {
	...
	private static final Map<String, String> mimeTypes = new HashMap<String, String>() {
		...
		private static final long serialVersionUID = -7347958304695006720L;
	...
	public static String getFromFileName(String filename) {
		...
		if (mimeTypes.containsKey(filename)) {
